...
file_id = '1BmCXd3TK-lAnKdUI4zvYQ42bfz4UQJzj'
...
app.layout = html.Div([
    # Title and Logo
    html.Div([
        # html.Img(src="your_logo.png", style={'height': '100px', 'width': '100px'}),
    ...
    dcc.Graph(
        id='pm25-map',
        style={'height': '600px', 'width': '100%'}  # Set the height of the Mapbox
    )
])
